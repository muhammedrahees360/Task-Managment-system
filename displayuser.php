...
if (isset($_SESSION['useruid'])) {
    ...
    if (isset($_GET["success"])) {
        if ($_GET["success"] == 'useradded') {
            echo "<center><p style='color:green;'>User  added successsfully</p></center>";
        } elseif ($_GET["success"] == 'userisadded') {
            echo "<center><p style='color:green;'>Vendor added successfully</p></center>";
        }elseif ($_GET["success"] == 'valueupdated') {
            echo "<center><p style='color:green;'> Updated successfully</p></center>";
        }
        elseif ($_GET["success"] == 'datadeleted') {
            echo "<center><p style='color:green;'>Successfully Deleted</p></center>";
        }
    }
?>
    <!DOCTYPE html>
