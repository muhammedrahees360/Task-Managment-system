...
<form class="row g-3" method="POST" action="addUser.php">
  ...
  <div class="col-md-6">
      ...
      <input type="date" class="form-control" required id="inputPassword4" name="duedate">
  </div>
  <div class="col-md-4">
    ...
    <div class="mb-3">
                ...
                <input style="max-width:25%" class="form-control" type="file" id="formFileMultiple" multiple>
   </div>
